                ...
                <a href="?p=input_supplier">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <?php  
                        ...
                        $query = "SELECT * FROM supplier where nama like '%".$cari."%'";
                        $no = 1;
                        ...
                        if(mysqli_num_rows($sql) >0){ //hitung jumlah baris
                          ...
                          <td><a href="index.php?p=edit_supplier&id_supplier=<?php echo $data["id_supplier"]; ?>" class="btn btn-success"><i class="fa fa-edit"></i>Ubah</a>
                          <a href="index.php?p=hapus_supplier&id_supplier=<?php echo $data["id_supplier"]; ?>" onclick=" return confirm('Anda Yakin Menghapus Data Ini');" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                          </td>
                          </tr>
                          <?php
                        }

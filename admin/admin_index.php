                ...
                <a href="?p=input_admin">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <?php  
                        ...
                        $query = "SELECT * FROM admin where nama like '%".$cari."%'";
                        $no = 1;
                        ...
                        if(mysqli_num_rows($sql) >0){ //hitung jumlah baris
                          ...
                          <td><a href="index.php?p=edit_admin&id_admin=<?php echo $data["id_admin"]; ?>" class="btn btn-success"><i class="fa fa-edit"></i>Ubah</a>
                          <a href="index.php?p=hapus_admin&id_admin=<?php echo $data["id_admin"]; ?>" onclick=" return confirm('Anda Yakin Menghapus Data Ini');" class="btn btn-danger"><i class="fa fa-trash"></i> Hapus</a>
                          </td>
                          </tr>
                          <?php
                        }
